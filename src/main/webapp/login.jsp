...
<body>
    ...
    <div class="section no-pad-bot" id="index-banner">
        <div class="container">
            <h1 class="header center purple-text">Ingreso</h1>
            <div class="row center">
                <h5 class="header col s12 light">Ingresa con tu usuario y contraseña</h5>
            </div> 
        </div>
    </div>
    <div class="row">
        <div class="container">
            <form action="" class="col s12">
                ...
                <div class="row">
                    <div class="input-field col offset-s4 s4">
                        <input type="password" class="validate" placeholder="contraseña" id="password">
